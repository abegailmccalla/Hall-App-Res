...
public class ElsaLeoRhynieHall implements HallOfResidence {
    ...
    numBlocks
    /**
     * The ElsaLeoRhynieHall Constructor thar adds sums the number of rooms and add
    ...
    /**
     * The function reserves a room based on the gender, budget, block name, and
     * room file provided.
     * 
     * @param gender    The gender of the person requesting to reserve a room
