...
public class RexNettlefordHall implements HallOfResidence {
    ...
    /**
     * The RexNettlefordHall Constructor thar adds sums the number of rooms and add
    ...
    /**
     * The function books a room based on the gender and budget of the user, and
     * checks for room
     * availability in a file.
     * 
     * @param gender The gender of the person booking the room (either male or
     *               female).
     * @param budget The budget the user has for booking a room.
